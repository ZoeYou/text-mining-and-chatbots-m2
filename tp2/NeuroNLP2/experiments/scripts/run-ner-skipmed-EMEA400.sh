...
CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=60 python ner.py --config configs/ner/quaero-100-demi.json --num_epochs 50 --batch_size 16 \
 ...
 --train "../../../TP_ISD2020/QUAERO_FrenchMed/EMEA/EMEAtrain_layer1_ID_400.conll" --dev "../../../TP_ISD2020/QUAERO_FrenchMed/EMEA/EMEAdev_layer1_ID.conll" --test "../../../TP_ISD2020/QUAERO_FrenchMed/EMEA/EMEAtest_layer1_ID.conll"
